...
<p align="center"> <img src="images/obamas.jpg" align="middle" alt="drawing" width="400px"> </p> 

+ **Detect facial keypoint with a Convolutional Neural Network**
<p align="center"> <img src="images/obamas_detect.png" align="middle" alt="drawing" width="300px"> </p>
...
1. Clone the repository, and navigate to the downloaded folder. This may take a minute or two to clone due to the included image data.
	...
	```
2. Create (and activate) a new Anaconda environment (Python 3.10).
Download via [Anaconda](https://www.anaconda.com/distribution/)

	- __Linux__ or __Mac__: 
	```
	conda create -n cv-nd python=3.10
	source activate cv-nd
	```
	- __Windows__: 
	```
	conda create --name cv-nd python=3.10
	activate cv-nd
	```
